...
MSA_GAP_IDX = constants.restypes_with_x_and_gap.index("-")
...
def _pad_templates(
    chains: Sequence[FeatureDict], max_templates: int
) -> Sequence[FeatureDict]:
...
def _merge_features_from_multiple_chains(
    chains: Sequence[FeatureDict], pair_msa_sequences: bool
) -> FeatureDict:
